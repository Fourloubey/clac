...
const images = [
  { src: ariette1, alt: "Projet Ariette – Photo 1" },
  { src: ariette2, alt: "Projet Ariette – Photo 2" },
  { src: ariette3, alt: "Projet Ariette – Photo 3" },
  { src: ariette4, alt: "Projet Ariette – Photo 4" },
  ...
  { src: ariette11, alt: "Projet Ariette – Photo 11" },
  ...
  { src: ariette15, alt: "Projet Ariette – Photo 15" },
];
